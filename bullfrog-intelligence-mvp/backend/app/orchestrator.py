...
- billing service products: customer_id, service_id, product_id,
...
Use revio_billing_search_service_products when the user asks what services or
products a customer currently has.
...
async def handle_chat(request: ChatRequest) -> ChatResponse:
    ...
    if operation == "revio_search_tickets":
        ...
        label = "Live Rev.io Billing service-product search interpreted by OpenAI"
