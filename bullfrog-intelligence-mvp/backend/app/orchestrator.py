        ...
        if customer_id_value is not None:
            ...
            if resolution.get("resolved"):
                ...
                normalized_requested = " ".join(
                    customer_name.casefold().split()
                )
                normalized_resolved = " ".join(
                    resolved_customer_name.casefold().split()
                )
                ...
                if normalized_requested != normalized_resolved:
                    data = {
                        ...
                        "customers": [
                            resolution.get("customer")
                            or {
                                "customerId": resolution.get("customer_id"),
                    ...
                    answer = (
                        f"Did you mean **{resolved_customer_name}**? "
                        "Reply yes or provide the full customer name."
                    )
                    _save_conversation(
                        conversation_id,
                    ...
                    return ChatResponse(
                        ...
                        sources=[
                            SourceReference(
                                ...
                                label="Customer-name match for contact search",
                            )
                        ],
                    )
