    ...
    if operation == "customer_360":
        ...
        async def customer_rest_ledger(
            ...
            *,
            ...
            """
            Pull the customer's actual Rev.io Billing Charges and Credits
            directly from the REST ledger endpoints. This deliberately
            bypasses the optional SOAP Transactions_Query path so an empty
            SOAP response cannot hide valid ledger activity.
            """
            ...
            return {
                ...
                "ledger_source": "rest_charges_credits_customer_direct",
                "created_date_start": created_date_start,
                "created_date_end": created_date_end,
                "page_size": normalized_page_size,
