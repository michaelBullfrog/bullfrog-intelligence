...
Choose revio_search_customers for general customer lookup by name.
    ...
    if operation == "revio_search_tickets":
        ...
        answer = await openai_response(
            instructions=(
                ...
                "PSA tickets, customers, contacts, projects, project activity, "
                "sales opportunities, and customer invoices. Do not pretend that "
