      ...
      <aside className="ribbitSidebar">
        <div className="sidebarTop">
          ...
          <div className="brandPanel">
            <img
              src="/bullfrog-logo.png"
              alt="Bullfrog Group"
              className="brandLogo"
            />
            <div>
              <p className="brandOverline">Bullfrog Group</p>
              <h1>Ribbit</h1>
              <p className="brandSubline">Bullfrog Intelligence</p>
            </div>
          </div>
      ...
      <section className="chatWorkspace">
        ...
        <div className="chatStream">
          ...
          {messages.map((item) => (
            ...
            >
              {item.role === "assistant" && (
                <div className="avatar assistantAvatar">R</div>
              )}
