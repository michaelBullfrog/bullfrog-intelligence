...
function StructuredResponse({
  ...
  return (
    <div className="structuredResponse">
        ...
        <section className="resultSection companyHealthSection">
          ...
          <div className="companySnapshotGrid">
            ...
            <article className="companySnapshotCard">
              <span>Billing</span>
              <strong>
                {pick(billingHealth, ["active_service_products"], "0")} active services
              </strong>
              <p>
                {pick(billingHealth, ["customers_returned"], "0")} customers returned
              </p>
            </article>
            ...
            <article className="companySnapshotCard">
              ...
              <p>
                {pick(renewalHealth, ["actionable_overdue"], "0")} actionable overdue
              </p>
            </article>
          </div>
      ...
      {!companyHealth && tickets.length > 0 && (
      ...
      {!companyHealth && projects.length > 0 && (
        <section className="resultSection">
          <div className="sectionHeader">
            <div>
      ...
      {!companyHealth && customers.length > 0 && (
        <section className="resultSection">
          <div className="sectionHeader">
            <div>
      ...
      {!companyHealth && contacts.length > 0 && (
        <section className="resultSection">
          <div className="sectionHeader">
            <div>
      ...
      {!companyHealth && invoices.length > 0 && (
        <section className="resultSection">
          <div className="sectionHeader">
            <div>
      ...
      {!companyHealth && ccwrRenewals.length > 0 && (
        <section className="resultSection">
          <div className="sectionHeader">
            <div>
      ...
      {!companyHealth && ledgerEntries.length > 0 && (
        <section className="resultSection">
          <div className="sectionHeader">
            <div>
