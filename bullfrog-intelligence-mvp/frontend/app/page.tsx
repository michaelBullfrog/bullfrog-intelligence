...
function renderInlineFormatting(text: string): ReactNode[] {
  const labelMatch = text.match(
    /^(Total active tickets|Total tickets|Ticket ID|Subject|Customer|Status|Priority|Assigned Engineer|Created|Modified|Closed|Queue|Agent|Subscription ID|Renewal Date|Renewal Bucket|Risk|Reseller|Bill To|Market|Source):\s*(.*)$/i
  );
