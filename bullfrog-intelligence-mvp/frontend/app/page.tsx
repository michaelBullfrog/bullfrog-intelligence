...
function reportTemplateDescription(template: string) {
  const descriptions: Record<string, string> = {
    executive:
      "Leadership view: KPIs, totals, major findings, and only a short supporting sample.",
    detailed:
      "Operations view: complete records with useful IDs, dates, statuses, amounts, and source fields.",
    customer_facing:
      "Customer-ready view: clean labels with internal IDs, API names, queries, and technical metadata removed.",
    audit:
